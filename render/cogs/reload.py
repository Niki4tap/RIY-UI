...
from .. import constants, synchronization

from ..db import TileData, Database
...
class ReloadCog:
    ...
    async def load_letter(self, word: str, tile_type: int):
        ...
        plates = [self.db.plate(None, i)[0].getchannel("A").convert("1") for i in range(3)]
